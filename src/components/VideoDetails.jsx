...
const VideoDetails = () => {
    ...
    return (
        <div className='flex justify-center flex-row h-[calc(100%-56px)] bg-black'>
            {video && video.stats && video.stats && (<div className='w-full max-w-[1280px] flex flex-col lg:flex-row'>
                ...
                <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
                    ...
                    <div className="flex justify-between flex-col md:flex-row mt-4">
                        ...
                        <div className="flex text-white mt-4 md:mt-3">
                ...
                {relatedVideos && relatedVideos?.contents && (
                    <div className="flex flex-col py-6 px-4 overflow-y-auto lg:w-[350px] xl:w-[400px]">
                        {relatedVideos?.contents?.map((item, index) => {
                            return <SuggestionVideoCard key={`${item?.video?.videoId}_${index}`} video={item?.video} />
                        })}
                    </div>
                )}
            </div>)}
